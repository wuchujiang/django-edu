# Generated by Django 3.2.9 on 2021-11-03 17:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail', DUEditor.models.UEditorField(default='', verbose_name='课程详情')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('learn_times', models.IntegerField(default=0, verbose_name='学习时长（分钟数）')),
                ('add_time', models.DateTimeField(default=datetime.datetime(2021, 11, 3, 17, 10, 35, 896616), verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2021, 11, 3, 17, 10, 35, 897658), verbose_name='添加时间')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.course', verbose_name='课程')),
            ],
            options={
                'verbose_name': '课程资源',
